    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
      <div class="lg:col-span-2 bg-white p-4 rounded-2xl shadow">
        ...
        <ul class="text-sm divide-y">
          <li class="py-2">
            Produto adicionado - Margarina - 10 unidades
            <span class="text-gray-500">(10 minutos atrás)</span>
          </li>
          <li class="py-2">
            Estoque Atualizado - Biscoito Oreo - -15 unidades
            <span class="text-gray-500">(25 minutos atrás)</span>
          </li>
          <li class="py-2">
            Entrega Confirmada - Coca-Cola pedido #447 - 32 itens
            <span class="text-gray-500">(1 hora atrás)</span>
          </li>
          <li class="py-2">
            Alerta de Estoque Baixo - Ovos de Galinha Caipira - 2 unidades restantes
            <span class="text-gray-500">(1 dia atrás)</span>
          </li>
        </ul>
      ...
      <div class="bg-yellow-100 p-4 rounded-2xl shadow">
        ...
        <ul class="text-sm">
          <li class="flex justify-between border-b py-1">
            Abacate <span class="text-red-600">1 restando</span>
          </li>
          <li class="flex justify-between border-b py-1">
            Suco de peroba
            <span class="text-red-600">
              2 unidades restando <span class="text-gray-500">(Mínimo: 9)</span>
            </span>
          </li>
          <li class="flex justify-between border-b py-1">
            Bolacha
            <span class="text-red-600">
              4 restando <span class="text-gray-500">(Mínimo: 7)</span>
            </span>
          </li>
        </ul>
